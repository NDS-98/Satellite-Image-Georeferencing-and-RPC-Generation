...
class Sticher:
    ...
    def stich(self, imageA,imageB, ratio=0.75, reprojThresh=10.0,
        showMatches=False):
    ...
    #cv2.imwrite('intermediate.jpg',matches)
        #imageA = imutils.resize(imageA, 10000,10000)
        #imageB = imutils.resize(imageB, 10000,10000)
    ...
    # convert the image to grayscale
        image=imutils.resize(image,1000,1000)
